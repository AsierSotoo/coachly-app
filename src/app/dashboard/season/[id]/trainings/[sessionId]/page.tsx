      ...
      <main className="max-w-xl mx-auto px-4 py-6 pb-16">
        ...
        <div className="flex items-start justify-between mb-6">
          <div>
            ...
            <p className="text-xs mt-0.5" style={{ color: '#64748b' }}>{cap}</p>
          </div>
          {sp.saved && (
            <span className="text-xs font-bold" style={{ color: '#4be277' }}>✓ Guardado</span>
          )}
        </div>
              ...
              <div className="divide-y" style={{ borderColor: '#2e3447' }}>
                ...
                <div className="flex flex-col gap-1 px-5 py-4">
                  <label className="text-[10px] font-bold uppercase tracking-widest" style={{ color: '#adb4ce' }}>
                    Título <span style={{ color: '#64748b' }}>(opcional)</span>
                  </label>
                ...
                <div className="flex flex-col gap-1 px-5 py-4">
                  <label className="text-[10px] font-bold uppercase tracking-widest" style={{ color: '#adb4ce' }}>
                    Duración (min) <span style={{ color: '#64748b' }}>(opcional)</span>
                  </label>
