  ...
  return (
    <form action={requestPasswordReset} className="flex flex-col gap-4">
      <div className="flex flex-col gap-2">
        <label htmlFor="email" className="text-[11px] font-bold uppercase tracking-wider" style={{ color: '#89968e' }}>
          Email
        </label>
      ...
      <Link href="/login" className="text-center text-xs transition-colors hover:underline" style={{ color: '#89968e' }}>
        ← Volver al login
      </Link>
    </form>
  )
