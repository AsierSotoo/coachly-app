  ...
  return (
    <div className="flex min-h-full">
      ...
      <div className="relative hidden lg:flex lg:w-1/2 flex-col justify-between overflow-hidden"
        ...
        {/* Degradado encima para legibilidad */}
        ...
        <div className="relative z-10 p-10">
          <blockquote className="space-y-3">
            <p className="text-2xl font-bold text-white leading-snug">
              "Las estadísticas que necesitas,<br />en el momento que las necesitas."
            </p>
            <p className="text-sm text-green-400/80">Para entrenadores de fútbol</p>
          </blockquote>

          <div className="mt-10 grid grid-cols-3 gap-4">
            {[
              { label: 'Goleadoras', val: '⚽' },
              { label: 'Estadísticas', val: '📊' },
              { label: 'Temporadas', val: '🏆' },
            ].map(({ label, val }) => (
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-6 py-12 lg:px-16">
        <div className="w-full max-w-sm">
          ...
          <p className="text-slate-400 text-sm mb-8">Entra en tu cuenta para continuar</p>
          ...
          <form action={login} className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <input id="password" name="password" type="password" required autoComplete="current-password" placeholder="••••••••" className="h-12 px-4 text-sm" />
            </div>
