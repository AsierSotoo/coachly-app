    ...
    <div className="flex min-h-screen flex-col items-center justify-center px-4 py-12"
      ...
      <div className="w-full max-w-sm rounded-2xl border border-[#1e293b] p-8"
        ...
        <div className="mb-6 text-center">
          <span className="material-symbols-outlined mb-3 block" style={{ color: '#4be277', fontSize: 36, fontVariationSettings: "'FILL' 1" }}>
            lock
          </span>
  ...
  return (
    <form action={updatePassword} className="flex flex-col gap-4">
      <div className="flex flex-col gap-2">
        <label htmlFor="password" className="text-[11px] font-bold uppercase tracking-wider" style={{ color: '#adb4ce' }}>
          Nueva contraseña
        </label>
