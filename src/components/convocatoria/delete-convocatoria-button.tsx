...
export function DeleteConvocatoriaButton({ id, seasonId }: { id: string; seasonId: string }) {
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="rounded-xl border border-slate-700 p-1.5 text-slate-600 hover:border-red-500/50 hover:bg-red-500/10 hover:text-red-400 transition-colors cursor-pointer"
      >
